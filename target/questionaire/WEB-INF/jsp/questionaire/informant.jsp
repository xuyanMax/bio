...
<body>
    <div class="container">
        ...
        <img src="/images/inform.png" class="img-responsive" alt="Cinque Terre" align="center">
    </div>
    ...
    <form class="form-inline" action="/survey" method="post" style="margin-left: auto; margin-right: auto">
        ...
        <button class="btn btn-default" type="submit" name="submit" disabled="true" id="submit">开始作答</button>
    </form>
