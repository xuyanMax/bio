...
<div class="login-form">
    <form name="dataInputForm" action="/admin/manualInsertion" method="post">
        ...
        <div class="form-group" id="ID_code_div">
            <input type="text" onchange="checkID();" class="form-control" placeholder="身份证号" required="required"
        ...
        <div class="form-group" id="sn_div">
            <input type="text" class="form-control" placeholder="单位内编号(工号)" required="required" name="sn_in_center"
                   id="sn_in_center">
