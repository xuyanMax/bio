...
<form action="/admin/update" method="post">
    ...
    <div class="form-group">
        邮箱: <input type="email" class="form-control" name="email" placeholder="邮箱" required="required"
                   value="xu.yan11@icloud.com">
    </div>
    <div class="form-group">
        单位内编号: <input type="text" class="form-control" name="sn_in_center" placeholder="单位内编号" required="required"
                      value="1100420">
    </div>
    <div class="form-group">
        系统内唯一编号: <input type="text" class="form-control" name="global_sn" placeholder="系统内唯一编号" required="required"
                        value="1406626">
    </div>
    <div class="form-group">
